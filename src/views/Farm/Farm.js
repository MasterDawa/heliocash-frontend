...
const Farm = () => {
  ...
  const rsharesActive = true // Date.now() >= config.rsharesLaunchesAt.getTime();
  ...
  return (
    <Switch>
      <Page>
              ...
              <Box mt={5}>
                <div hidden={activeBanks.filter((bank) => bank.sectionInUI === 2).length === 0}>
                  ...
                  { <Alert variant="filled" severity="info">
                    <h4>
                      Farms started October 6th 2022 and will continue running for 1 full year.</h4>
        ...
        {!!account && !rsharesActive && <div style={{marginTop: '2rem'}}><LaunchCountdown deadline={config.rsharesLaunchesAt} description='RSHARE Farms'/></div>}
      </Page>
    </Switch>
  );
};
