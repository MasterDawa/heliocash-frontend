...
import userShareStats from '../../hooks/usehRhareStats';
...
const Home = () => {
        ...
        const respectPriceInDollars = useMemo(
            () => (respectStats ? Number(respectStats.priceInDollars).toFixed(2) : null), [respectStats],
        );
        const helioPriceInMATIC = useMemo(() => (respectStats ? Number(respectStats.tokenInETH).toFixed(4) : null), [respectStats]);
        const helioCirculatingSupply = useMemo(() => (respectStats ? String(respectStats.circulatingSupply) : null), [respectStats]);
        const helioTotalSupply = useMemo(() => (respectStats ? String(respectStats.totalSupply) : null), [respectStats]);

        const hSharePriceInDollars = useMemo(
            () => (rShareStats ? Number(rShareStats.priceInDollars).toFixed(2) : null), [rShareStats],
        );
        const hSharePriceInMATIC = useMemo(
            () => (rShareStats ? Number(rShareStats.tokenInETH).toFixed(4) : null), [rShareStats],
        );
        const hShareCirculatingSupply = useMemo(
            () => (rShareStats ? String(rShareStats.circulatingSupply) : null), [rShareStats],
        );
        const hShareTotalSupply = useMemo(() => (rShareStats ? String(rShareStats.totalSupply) : null), [rShareStats]);

        const tBondPriceInDollars = useMemo(
            () => (tBondStats ? Number(tBondStats.priceInDollars).toFixed(2) : null), [tBondStats],
        );
        const tBondPriceInMATIC = useMemo(() => (tBondStats ? Number(tBondStats.tokenInETH).toFixed(4) : null), [tBondStats]);
        const tBondCirculatingSupply = useMemo(
            () => (tBondStats ? String(tBondStats.circulatingSupply) : null), [tBondStats],
        );
        ...
        const [onPresentHelioZap, onDissmissHelioZap] = useModal( <
            ZapModal decimals = { 18 }
            onConfirm = {
                (zappingToken, tokenName, amount, slippageBp) => {
        ...
        return ( <
                ...
                BackgroundImage / >
                <
                Grid container spacing = { 3 } > { /* Logo */ } <
                Grid item xs = { 12 }
                sm = { 4 }
                style = {
                    { display: 'flex', justifyContent: 'center', verticalAlign: 'middle', overflow: 'hidden' } } >
                <
                img src = { HelioImage }
                alt = "helio-logo"
                style = {
                ...
                p >
                <
                IconTelegram alt = "telegram"
                style = {
                    { fill: '#dddfee', height: '15px' } }
                /> Join our{' '} <
                a href = "https://t.me/respfin"
                ...
                <
                h2 style = {
                    { paddingTop: '4px' } } > Total Value Locked < /h2> <
                CountUp style = {
                    { fontSize: '25px' } }
                end = { TVL }
                separator = ","
                ...
                CardContent align = "center"
                style = {
                    { marginTop: '1.8%', padding: '16px' } } > { /* <h2 style={{ marginBottom: '20px' }}>Wallet Balance</h2> */ } {
                ...
                /Button> { < Button
                    ...
                    style = {
                            { position: 'absolute', top: '10px', right: '10px', border: '1px grey solid' } } >
                        { ' ' } <
                        b > + < /b>&nbsp;&nbsp; <
                        img alt = "metamask fox"
                    style = {
                        { width: '20px', filter: 'grayscale(100%)' } }
                    src = { MetamaskFox }
                    /> <
                    /Button> <
                    h2 style = {
                        { marginBottom: '10px' } } > HELIO < /h2>
                    4, 000 RESPECT(1.0 Peg) = <
                        Box >
                        <
                        span style = {
                            { fontSize: '30px', color: 'white' } } > { respectPriceInMATIC ? respectPriceInMATIC : '-.----' }
                    ETH < /span> <
                        /Box> <
                        Box >
                        <
                        span style = {
                            { fontSize: '16px', alignContent: 'flex-start' } } >
                        $ { respectPriceInDollars ? roundAndFormatNumber(respectPriceInDollars, 2) : '-.--' }
                    / RESPECT <
                    /span> <
                    /Box> <
                    span style = {
                    ...
                    onClick = {
                        () => {
                            respectFinance.watchAssetInMetamask('RSHARE');
                        }
                    }
                    style = {
                            { position: 'absolute', top: '10px', right: '10px', border: '1px grey solid' } } >
                    ...
                    Box mt = { 2 } >
                        ...
                        /Box> <
                        h2 style = {
                            { marginBottom: '10px' } } > RSHARE < /h2>
                    Current Price
                        <
                        Box >
                        <
                        span style = {
                            { fontSize: '30px', color: 'white' } } > { rSharePriceInMATIC ? rSharePriceInMATIC : '-.----' }
                    MATIC
                        <
                        /span> <
                        /Box> <
                        ...
                        <
                        span style = {
                            { fontSize: '16px' } } > $ { rSharePriceInDollars ? rSharePriceInDollars : '-.--' }
                    / RSHARE</span >
                    <
                    /Box> <
                    span style = {
                    ...
                    Box mt = { 2 } >
                        ...
                        /Box> <
                        h2 style = {
                            { marginBottom: '10px' } } > RBOND < /h2>
                    4, 000 RBOND
                        <
                        Box >
                        <
                        span style = {
                            { fontSize: '30px', color: 'white' } } > { tBondPriceInMATIC ? tBondPriceInMATIC : '-.----' }
                    ETH
                        <
                        /span> <
                        /Box> <
                        ...
                        <
                        span style = {
                            { fontSize: '16px' } } > $ { tBondPriceInDollars ? tBondPriceInDollars : '-.--' }
                    / RBOND</span >
                    <
                    /Box> <
                    span style = {
                    ...
                    style = {
                        ...
                        Box mt = { 2 } >
                        <
                        Button onClick = { onPresentHelioZap }
                    className = "shinyButtonSecondary" >
                        ...
                        <
                        span style = {
                            { fontSize: '26px' } } > { respectLPStats ? .tokenAmount ? respectLPStats ? .tokenAmount : '-.--' }
                    RESPECT / { ' ' } { respectLPStats ? .ftmAmount ? respectLPStats ? .ftmAmount : '-.--' }
                    ETH
                        <
                        /span> <
                        /Box> <
                    ...
                    gutterBottom >
                        ...
                        <
                        b style = {
                            { fontSize: '14px' } } > { boardroomValue } % < /b> <
                        div > BOARDROOM < /div> <
                        /div> <
                        div style = {
                            { width: '100%' } } > { ' ' } < /div> <
                        ...
                        <
                        b style = {
                            { fontSize: '14px' } } > { 100 - boardroomValue } % < /b> <
                        div > FARMS < /div> <
                        /div> <
                        /Typography> <
                        Slider
                    ...
                    gutterBottom >
                        ...
                        div > HSHARE - LP < /div> <
                        b style = {
                            { fontSize: '14px' } } > { 100 - strategyValue } % < /b> <
                        /div> <
                        /Typography> <
                        Box mt = { 1 } > {!loading ?
                            <
                            Button onClick = {
                                () => approvalStateStrategy === ApprovalState.APPROVED ? executeStrategy() : executeApprovals() }
                            className = "shinyButtonSecondary" > { approvalStateStrategy === ApprovalState.APPROVED ? 'Start' : 'Approve' } <
                            /Button> :
                                <
                                div style = {
                                ...
                                <
                                div style = {
                                    { fontSize: '12px', marginTop: '12px', color: '#7e48aa' } } > < i > Submitting multiple transactions... < /i></div >
                                <
                                /div>
                        } <
                        /Box> <
                        /Box> {
                            ...
                            flexWrap = { 0 } >
                                ...
                                Button size = 'small'
                            style = {
                                { marginTop: '16px', color: '#800080', marginBottom: '-5px' } }
                            ...
                            sm = { 4 } >
                                ...
                                CardContent align = "center"
                            style = {
                                    { marginBottom: isMobile ? '0' : '3.35rem' } } >
                                <
                                Box mt = { 2 } >
                                <
                                CardIcon >
                                ...
                                Box mt = { 2 } >
                                <
                                Button onClick = { onPresentHshareZap }
                            className = "shinyButtonSecondary" >
                                Zap In <
                                /Button> <
                                /Box> <
                                ...
                                <
                                span style = {
                                    { fontSize: '26px' } } > { bshareLPStats ? .tokenAmount ? bshareLPStats ? .tokenAmount : '-.--' }
                            RSHARE / { ' ' } { bshareLPStats ? .ftmAmount ? bshareLPStats ? .ftmAmount : '-.--' }
                            MATIC
                                <
                                /span> <
                                /Box> <
                                ...
                                span style = {
                                    { fontSize: '12px' } } >
                                Liquidity: $ { bshareLPStats ? .totalLiquidity ? roundAndFormatNumber(bshareLPStats.totalLiquidity, 2) : '-.--' } <
                                br / >
