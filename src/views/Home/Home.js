...
const Home = () => {
        ...
        return ( <
            ...
            } > { respectPriceInMATIC ? respectPriceInMATIC : '-.----' }
            ETH < /span> < /
            Box > <
            Box >
            <
            ...
            span style = {
                { fontSize: '30px', color: 'white' }
            } > { rSharePriceInMATIC ? rSharePriceInMATIC : '-.----' }
            MATIC <
            /span> < /
            Box > <
            Box >
            ...
            span style = {
                { fontSize: '16px' }
            } > $ { rSharePriceInDollars ? rSharePriceInDollars : '-.--' }
            / RSHARE</span >
            <
            /Box> <
            span style = {
            ...
            span style = {
                { fontSize: '30px', color: 'white' }
            } > { tBondPriceInMATIC ? tBondPriceInMATIC : '-.----' }
            ETH <
            /span> < /
            Box > <
            Box >
            ...
            span style = {
                { fontSize: '26px' }
            } > { respectLPStats ? .tokenAmount ? respectLPStats ? .tokenAmount : '-.--' }
            ...
            Box mt = { 1 } > {!loading ?
                ...
                <
                div style = {
                    { fontSize: '12px', marginTop: '12px', color: '#7e48aa' }
                } > < i > Submitting multiple transactions... < /i></div >
                <
                /div>
            } <
            /Box> < /
            Box > {
                ...
                span style = {
                    { fontSize: '26px' }
                } > { bshareLPStats ? .tokenAmount ? bshareLPStats ? .tokenAmount : '-.--' }
