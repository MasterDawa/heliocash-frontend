...
const Boardroom = () => {
  ...
  return (
    <Page>
      <BackgroundImage />
      {!!account ? (
        !hsharesActive ? <LaunchCountdown deadline={config.boardroomLaunchesAt} description='Home' descriptionLink='/' />
          : <>
                  ...
                  <Card className={classes.gridItem}>
                    <CardContent align="center">
                      <Typography style={{ textTransform: 'uppercase', color: '#7e48aa' }}>
                        HELIO PEG <small>(TWAP)</small>
                      </Typography>
                      <Typography>{scalingFactor} ETH</Typography>
                      <Typography>
                        <small>per 4,000 HELIO</small>
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
