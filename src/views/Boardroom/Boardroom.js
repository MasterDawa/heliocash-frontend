...
const Boardroom = () => {
    ...
    return ( <
        ...
        BackgroundImage / > {!!account ? (!rsharesActive ? < LaunchCountdown deadline = { config.boardroomLaunchesAt }
                ...
                <
                Typography style = {
                    { textTransform: 'uppercase', color: '#7e48aa' } } > Next Epoch < /Typography> <
                ...
                <
                Typography style = {
                    { textTransform: 'uppercase', color: '#7e48aa' } } > Current Epoch < /Typography> <
                ...
                <
                Typography style = {
                    { textTransform: 'uppercase', color: '#7e48aa' } } >
                RESPECT PEG < small > (TWAP) < /small> <
                /Typography> <
                Typography > { scalingFactor }
                ETH < /Typography> <
                Typography >
                <
                ...
                <
                Typography style = {
                    { textTransform: 'uppercase', color: '#7e48aa' } } > APR < /Typography> <
