...
import useProvideRespectEthLP from '../../hooks/useProvideRespectFtmLP';
...
const ProvideLiquidity = () => {
  ...
  const {onProvideRespectEthLP} = useProvideRespectEthLP();
  ...
  // const PriceInETH = useMemo(() => (respectFtmLpStats ? Number(respectFtmLpStats.priceOfOne).toFixed(2) : null), [respectFtmLpStats]);
        ...
        <Box style={{width: '600px'}}>
          {/* <Alert variant="filled" severity="warning" style={{marginBottom: '10px'}}>
            <b>
              ...
              are the only ways to provide Liquidity on RESPECT-ETH pair without paying tax.
            </b>
          </Alert> */}
                ...
                <Grid item xs={12} sm={12} style={{borderRadius: 15}}>
                  <Box p={4}>
                    <Grid container>
                      <Grid item xs={12}>
                        <TokenInput
                          onSelectMax={handleRespectSelectMax}
                      ...
                      <Grid item xs={12}>
                        {/* <p>1 RESPECT = {respectPriceInETH} ETH</p> */}
                        {/* <p>1 ETH = {ethPriceInRESPECT} RESPECT</p> */}
                      ...
                      <Grid xs={12} justifyContent="center" style={{textAlign: 'center'}}>
                        {approveTaxOfficeStatus0 === ApprovalState.APPROVED && approveTaxOfficeStatus1 === ApprovalState.APPROVED ? (
                          <Button
                            variant="contained"
                            onClick={() => onProvideRespectEthLP(ftmAmount.toString(), respectAmount.toString())}
                            color="primary"
